...
There are a number of hypotheses regarding the \acrshort{cre} of tropical anvil
...
An example of observations from \acrshort{seviri} is shown in fig. 1 for 15:00:00
...
Figure 7(a) shows the average mean \acrshort{ctt} (\acrshort{ctt}), and Fig.
...
Figure 11 shows the distribution of net lifetime \acrshort{cre} for all tracked
anvils. The overall negative average value of -8.17\textpm0.85
...
\begin{figure}[t]
    ...
    as shown in figure 1 (15:00:00 \acrshort{utc} on 2016/6/01). a: net \acrshort{toa} radiative flux. b: net \acrshort{toa} \acrshort{cre}. c: \acrshort{sw} downwards \acrshort{cre}. d: \acrshort{lw} downwards \acrshort{cre}.
    }
...
over all anvils, weighted by the anvil areas (0.86\textpm0.91
\,\unit{W m^{-2}}).
