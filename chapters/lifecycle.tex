...
The anvil maximum area distribution has a similar shape for both thick anvil (fig.~\ref{fig:anvil_properties}\,a) and thin anvil (fig.~\ref{fig:anvil_properties}\,b), with the mean shifted to large values for the thin anvil.
...
The minimum anvil \acrshort{bt} have broader distribution than that of the average anvil \acrshort{bt}.
