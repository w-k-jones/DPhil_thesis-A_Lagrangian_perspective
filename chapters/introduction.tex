...
As a result, for small, fast-moving objects (such as convective cells), or observations that are more widely spaces, overlap methods perform poorly.
...
Despite the vast increase in computational power available compared to the early days of tracking algorithms, the vast quantities of data required for these analyses constrains the methods used.
