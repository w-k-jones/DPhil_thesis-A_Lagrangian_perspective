...
As $\tau$ varies very little in the range of visible wavelengths \citep{hu_accurate_1993}, the values are considered directly comparable with those retrieved using geostationary satellite observations at 640\,\unit{nm}.
