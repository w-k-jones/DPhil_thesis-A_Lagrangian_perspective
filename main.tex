...
\include{chapters/2_tracking_method}
\include{chapters/3_lifecycle}
\include{chapters/4_anvil_structure}
\include{chapters/5_radiative_effect}
\include{chapters/6_conclusion}

%now enable appendix numbering format and include any appendices
% \appendix
% \include{appendices/code_availability}
% \include{appendices/data_availability}
